...
function HeroHome() {
  ...
  return (
    <section className="relative bg-gray-1200">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 ">
        ...
        <div className="pt-32 pb-12 md:pt-40 md:pb-20">
          ...
          <div className="text-center pb-12 md:pb-16">
            <h1 className="text-5xl md:text-6xl font-extrabold leading-tighter tracking-tighter mb-4 text-blue-1100" data-aos="zoom-y-out">Factor<span className="bg-clip-text text-blue-1000">Legal</span></h1>
            <div className="max-w-3xl mx-auto">
              <p className="text-xl text-gray-600 mb-8" data-aos="zoom-y-out" data-aos-delay="150">Asesoramiento jurídico especializado</p>
